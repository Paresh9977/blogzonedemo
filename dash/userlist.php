      ...
      <?php
  include "./config.php";
  $sql3="SELECT * FROM reguser ORDER BY id DESC";
...
?>
         <tr>
            ...
            <td scope='row'><?php   echo $row["regemail"]; ?></td>
            <?php 
            if($_SESSION["Utype"]=="admin"){
  echo '<td scope="row">
  <a href="#"><i class="fas fa-edit fa-3 text-primary"></i></a>
</td>
<td scope="row">
<a href="deluser.php?pid='.$row['id'].'"><i class=" fas fa-trash fa-3 text-danger"></i></a>
</td>
 ';
} 
else{
